...
if authentication_status:
    ...
    def get_data(symbol,start,end):
        ...
        if symbol.upper()=='WIPRO':
            df = pd.read_csv("C:/Users/Shreyas Nimje/stockmarket_project/streamlit-sales-dashboard-with-userauthentication-master\streamlit-sales-dashboard-with-userauthentication-master/WIPRO.csv")
        elif symbol.upper() == 'NTPC':
            df = pd.read_csv("C:/Users/Shreyas Nimje/stockmarket_project/streamlit-sales-dashboard-with-userauthentication-master\streamlit-sales-dashboard-with-userauthentication-master/NTPC.csv")
        elif symbol.upper() == 'ITC':
            df = pd.read_csv("C:/Users/Shreyas Nimje/stockmarket_project/streamlit-sales-dashboard-with-userauthentication-master\streamlit-sales-dashboard-with-userauthentication-master/ITC.csv")
            
        elif symbol.upper() == 'CANARA BANK':
            df = pd.read_csv("C:/Users/Shreyas Nimje/stockmarket_project/streamlit-sales-dashboard-with-userauthentication-master\streamlit-sales-dashboard-with-userauthentication-master/canara.csv")
        else:
